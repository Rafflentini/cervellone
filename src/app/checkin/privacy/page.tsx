      ...
      */}
      ...
      <ul>
        ...
        <li>
          ...
          amministrativa e lettura automatica della fotografia del documento, <strong>solo se la
          carica</strong> — vedi il punto 8). Alcuni di questi fornitori possono trattare dati al di fuori dell&apos;Unione
      ...
      <p>
        Per evitarle di ricopiare a mano una dozzina di dati, <strong>appena carica la fotografia del
        documento</strong> questa viene letta da un sistema automatico che compila da solo i campi del
        modulo. È l&apos;unico scopo di quella lettura, e avviene una volta sola per ciascuna immagine.
      </p>
      <p>
        Quello che non si legge con chiarezza resta <strong>vuoto</strong>, da scrivere a mano. Quello
        che viene compilato è <strong>sempre modificabile</strong>, come qualunque altro campo, e non
        sostituisce mai un dato che lei aveva già scritto.
      ...
      <p>
        ...
        all&apos;operazione e non è utilizzata per addestrare modelli. Se preferisce evitarla, può non
        caricare la fotografia: <strong>non è obbligatoria</strong>, e può compilare tutti i campi a
        mano senza alcuna conseguenza.
      </p>
      <p className="en">
        When you upload the document photo it is read automatically to fill in the form. Anything not
        clearly readable is left blank, everything filled in remains editable, it never overwrites what
        you typed, and no automated decision is made about you. Uploading the photo is optional.
      </p>
