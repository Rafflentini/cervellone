...
- Name: doc-preview.spec.ts >> Pagina documento pubblico /doc/[id] >> pagina /doc/ non richiede autenticazione
- Location: tests\doc-preview.spec.ts:16:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/doc/test-id
Call log:
  - navigating to "http://localhost:3000/doc/test-id", waiting until "load"
